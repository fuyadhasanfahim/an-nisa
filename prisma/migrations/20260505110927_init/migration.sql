...
-- CreateIndex
CREATE INDEX "custom_order_userId_idx" ON "custom_order"("userId");
...
-- AddForeignKey
ALTER TABLE "custom_order" ADD CONSTRAINT "custom_order_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
